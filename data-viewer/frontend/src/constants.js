...
export const ENDPOINTS = {
  ...
  streamsLogin: `${APP_API_URL}/streams/auth/login`,
  streamsLogout: `${APP_API_URL}/streams/auth/logout`,
  streamsOptions: `${APP_API_URL}/streams/options`,
  streamsGauges: `${APP_API_URL}/streams/gauges`,
  streamsDownload: `${APP_API_URL}/streams/download`
}
